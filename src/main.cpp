 ...
 *  v1.8    Ported to Qt 5
 *  v1.8.1  Output pixel format of ffmpeg avi yuv420p (better supported) instead of yuv444p
 */

extern const QString applicationName("Route Generator version 1.8.1");
