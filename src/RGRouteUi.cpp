...
void RGRouteUi::reFillVehicleComboFromVehicleList()
{
    ...
    {
        ui->vehicleCB->addItem(QIcon(mVehicleList->getVehicle(i)->getPixmapAtSize(16)),
                               mVehicleList->getVehicle(i)->getName()); //QIcon(mVehicleList->getVehicle(i)->getPixmapAtSize(16)),
    }
